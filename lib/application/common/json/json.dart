...
import 'package:sona/application/common/validation/map_validations.dart';
...
class _JsonCodec<T> {
  ...
  static void register<T>({required FromJsonMap<T> fromJsonMap, required ToJsonMap<T> toJsonMap}) {
    ...
    List<T> fromJsonArray(dynamic json) => (json as List).mapList(fromJsonObject);
    List<Map<String, dynamic>> toJsonArray(List<T> value) => value.mapList(toJsonObject);
